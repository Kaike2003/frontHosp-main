            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                <div className="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
                    <div className="flex items-start flex-col">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 lg:text-3xl dark:text-white">Quarto Suite</h2>

                        <p className="hidden max-w-screen-sm text-gray-600 dark:text-gray-300 md:block">
                            Características típicas de um quarto suite em nossa hospedaria: Espaço adicional, cama de casal ou king-size, banheiro privativo espaçoso, área de estar, comodidades extras, vistas panorâmicas e decoração de alta qualidade.
                        </p>
                    </div>
