...
function TabelaReservasPendentes() {
    ...
    const callBackReserva = useCallback(() => {
        ...
        api.get(`/publico/listarTodasReservasPendentes`).then(async (sucesso) => {
            ...
            <Box>
                <IconButton
                    ...
                    onClick={async () => {
                        ...
                        await api.put(`/admin/confirmarReserva/${row.original.id}`).then((res) => {
...
export default TabelaReservasPendentes